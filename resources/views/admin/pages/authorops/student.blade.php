        ...
        <div class="col">
            <div class="card shadow bg-white" style="border-radius: 1.5em">
                <div class="card-header py-3 bg-white" style="border-radius: 1.5em; border-bottom-left-radius: 0px;border-bottom-right-radius: 0px">
                    <h6 class="m-0 font-weight-bold text-gray-900 text-uppercase">Daftar Murid</h6>
                </div>
                <div class="card-body">
                    <a href="{{ route('admincreateacc',['role' => 'student']) }}" class="btn text-white bg-primarycust-non-gr">
                        Tambah Data
                    </a>
                    ...
                    <div class="search mt-3">
                        <form action="/admin/student" class="container-fluid p-0" method="GET">
                            <div class="input-group w-25 mb-4">
                                <input type="text" class="form-control bg-light border-0 small"
                                    placeholder="Cari NISN..." aria-label="Search" aria-describedby="basic-addon2"
                                ...
                                @foreach ($collection as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="{{ route('adminshowacc',['id' => Crypt::encrypt($item->id),'role' => 'student']) }}" class="mx-2 btn btn-warning">Edit</a>
