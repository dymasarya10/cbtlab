        ...
        <div class="col-md-12 col-lg-7">
            <div class="card bg-white p-3" style="border-radius: 3em">
                <div class="card-header py-3 bg-white"
                    ...
                    <h6 class="m-0 font-weight-bold text-gray-900 text-uppercase">Daftar Kelas</h6>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($collection as $item)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <form action="{{ route('destroygrade') }}" method="POST">
                                                @csrf
                                                @method('delete')
                                                <input type="hidden" value="{{ $item->id }}" name="target">
                                                <button onclick="return confirm('Hapus Kelas {{ $item->name }} ?')"
                ...
                <form action="{{ route('storegrade') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <small id="emailHelp" class="form-text text-muted">* contoh : 7 / 10-RPL. TK ditulis 0</small>
                          </div>
                          <div class="form-group">
